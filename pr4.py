...
def cov_m(var_x,var_y,co_var):
	cov_mat = numpy.zeros(shape=(2,2))
	cov_mat[0,0] = var_x
	cov_mat[0,1] = cov_mat[1,0] = co_var
	cov_mat[1,1] = var_y
	return cov_mat
...
cov_m1 = cov_m(var_x1,var_y1,co_1)
cov_m2 = cov_m(var_x2,var_y2,co_2)
...
plt.contour(x, y,(a_t[0,0]*x**2 + e*x*y + a_t[1,1]*y**2 + b[0,0]*x + b[0,1]*y + c), [0], colors='r')
