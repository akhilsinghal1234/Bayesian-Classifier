...
python3 "$number$postfix1" < $prefix'2_12'$postfix >"Output/linear/$number/Linear_$number.dat"
python3 "$number$postfix1" < $prefix'2_13'$postfix >"Output/linear/$number/Linear_$number.dat"
python3 "$number$postfix1" < $prefix'2_23'$postfix >"Output/linear/$number/Linear_$number.dat"
python3 "$number$postfix1" < $prefix'3_123'$postfix >"Output/linear/$number/Linear_$number.dat"
...
for number in 1 2 3 4;do
echo "Running Program For Case $number.\n"
python3 "$number$postfix1" < $prefix'2_12'$postfix >"Output/non_linear/$number/Non_Linear_$number.dat"
python3 "$number$postfix1" < $prefix'2_13'$postfix >"Output/non_linear/$number/Non_Linear_$number.dat"
python3 "$number$postfix1" < $prefix'2_23'$postfix >"Output/non_linear/$number/Non_Linear_$number.dat"
python3 "$number$postfix1" < $prefix'3_123'$postfix >"Output/non_linear/$number/Non_Linear_$number.dat"
echo "Completed Program For Case $number.\n"
done
